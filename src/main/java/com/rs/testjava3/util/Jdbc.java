...
public final class Jdbc {
    ...
    private static String url = "jdbc:mysql://localhost:3306/sof203_bvasm";
...
//			BeanUtils.populate(bean, map);
     ...
     * </pre>
     */
    public static <T> T getSingleResult(Class<T> beanClass, String sql, Object... values) throws SQLException, ClassNotFoundException {
